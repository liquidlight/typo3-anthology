...
At a minimum, you need a :samp:`ctrl` section in your TCA file with a :samp:`title`. This title is what will appear in the plugin's "Model name" selection box.
...
To fetch the data from your table, the Anthology extension needs a corresponding Extbase repository. This repository **must** have the :php:`LiquidLight\Anthology\Attribute\AsAnthologyRepository` attribute with the corresponding TCA/table name argument.
