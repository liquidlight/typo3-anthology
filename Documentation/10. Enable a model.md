...
To fetch the data from your table, the Anthology extension needs a corresponding Extbase repository.
...
This is the crucial step that connects your model to the Anthology extension. You must register your repository in your site's TypoScript setup.
...
## 4. Select the Model in the Plugin
